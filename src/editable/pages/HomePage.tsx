...
import { EditableHomeCta, EditableHomeHero, EditableFeaturedSpotlight, EditableMagazineSplit, EditableQuickActions, EditableStoryRail, EditableTimeCollections } from '@/editable/sections/HomeSections'
...
export default async function HomePage() {
  ...
  return (
    <EditableSiteShell>
      ...
      <EditableQuickActions primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
      <div className="mx-auto max-w-6xl px-4 py-6">
  <Ads slot="header" showLabel eager className="mx-auto w-full" />
</div>

      <EditableFeaturedSpotlight primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
