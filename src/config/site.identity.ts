export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'visives',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Visives',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'visives.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://visives.com',
